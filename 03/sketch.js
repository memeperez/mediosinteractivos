...
line(lx3,ly3+16*2,lx23,ly23+16*2);  
  ...
  // tiembla 1
  if (millis1 > 2000  && millis1 < 30000) {
    if(millis1>2000 && millis1<3000)
...
//linea que se mueve
 ...
 //tiembla 2
    ...
    //tiembla 3 en blanco
    if(millis1>17000 && millis1<18000)
    ...
    //tiembla 5
    if(millis1>22000 && millis1<23000)
    ...
    //tiembla 6
    if(millis1>28000 && millis1<29000)
    ...
    //tiembla 7
    if(millis1>33000 && millis1<34000)
    ...
    if(millis1>17000 && millis1<18000){
      ...
      //linea en movimiento
          if(millis1>24000 && millis1<27000)
